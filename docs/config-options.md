...
globalClientConfigs:
  # [Optional] The Spanner endpoint to use. Defaults to "spanner.googleapis.com:443".
  spannerEndpoint: "spanner.googleapis.com:443"
  # [Optional] Enables built-in metrics. Defaults to false.
...
listeners:
  ...
  - name: "listener_1"
    ...
    spanner:
      ...
      numGrpcChannels: 4
      # [Optional] The maximum commit delay in milliseconds. Defaults to none.
